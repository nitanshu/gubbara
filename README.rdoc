...
The admin who will create the notice for all the users will be able to configure *background_color*, *font_color*, *font_size* and *text_allignment* for a particulare notice.
